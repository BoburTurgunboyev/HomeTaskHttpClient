...
namespace HttpClientAppp
{
    public class CrudMethods
    {
        ...
        public async Task<string> GetAllAsync()
        {
            ...
            {
                jsn = await client.GetAsync(url).Result.Content.ReadAsStringAsync();
        ...
        public async Task<string> GetByIdAsync(int id)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                jsn = await client.GetAsync(query).Result.Content.ReadAsStringAsync();
            }
            return jsn;
        }
